...
ROLE_CATEGORIES: dict[str, dict] = {
    "software_engineering": {
        ...
        "keywords": ["code", "coding", "programming", "software", "development", "desenvolvimento"],
    },
    "devops_sre": {
        "base_level": 4,
        "titles": [
        ...
        "keywords": ["devops", "sre", "infrastructure", "cloud", "kubernetes", "docker", "infraestrutura"],
    },
    "data_engineering": {
        "base_level": 4,
        "titles": [
        ...
        "keywords": ["data pipeline", "etl", "warehouse", "spark", "airflow", "dados"],
    },
    "data_science": {
        "base_level": 4,
        "titles": [
        ...
        "keywords": ["machine learning", "ml", "ai", "neural network", "model training", "aprendizado de máquina"],
    },
    "ai_ml": {
        "base_level": 4,
        "titles": [
        ...
        "keywords": ["llm", "gpt", "langchain", "rag", "fine-tuning", "embeddings", "inteligência artificial"],
    },
    "product_management": {
        "base_level": 4,
        "titles": [
